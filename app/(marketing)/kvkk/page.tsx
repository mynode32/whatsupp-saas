...
const M = {
  tr: {
    ...
    sections: [
      ...
      { h: "Veri sahibinin hakları", b: "Kişisel verilerin silinmesini talep eden müşteriler için işletme, Ayarlar üzerinden ilgili kişinin verisini kalıcı olarak silebilir." },
  ...
  en: {
    ...
    sections: [
      ...
      { h: "Data subject rights", b: "For customers requesting deletion of their personal data, the business can permanently delete that contact's data from Settings." },
